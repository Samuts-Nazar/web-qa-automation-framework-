...
**Trenerkok**
GitHub: [@Trenerkok](https://github.com/Trenerkok)

> Проєкт розроблено як кваліфікаційна дипломна робота з теми автоматизованого тестування програмного забезпечення. Фреймворк демонструє практичні навички в галузі QA Automation: проєктування тестової архітектури, написання автотестів, налаштування CI/CD та формування звітності.
